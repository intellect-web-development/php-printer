...
namespace IWD\PhpPrinter\Php\Printer\Class;
...
readonly class Printer
{
    ...
    {
        return $file instanceof PhpClass;
    }
    ...
    public function print(File $file): string
    {
        ...
        return $this->helper->renderClassFile($file, $uses);
    }

    /**
     * @return ObjectType[]
     */
    public static function extractUses(PhpClass $file): array
    {
        $uses = [];
        if (null !== $file->uses) {
